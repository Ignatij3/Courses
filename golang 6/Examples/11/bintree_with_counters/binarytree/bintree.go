...
func (t BinTree) Size()  int { return bTree(t).Size() }	
...
func (t *BinTree) Insert(newval interface{}, toLeft func(newval, rootval interface{}) bool) {
	if bTree(*t).Empty() {
		t.root = &Node{value: newval, lson: NewBinTree(), rson: NewBinTree(), size: 1}
		return
	}
	...
	t.root.size = t.Left().Size() + 1 + t.Right().Size()
}
...
func (t BinTree) FindKth(k int) interface{} {
	return findKth(bTree(t), k)	
}		
